...
//    }
    ...
    private fun registerReceiver(receiver: MyReciever, it: IntentFilter) {

    }

    private fun send_SMS(position: Int) {
        val SENT_ACTION="org.example.terminal.SENT_ACTION"
    ...
    private fun recv_MSG() {
        val recvBroadcast:Broad castReceiver=object:BroadcastReceiver(){
            override fun onReceive(p0: Context?, p1: Intent?) {
